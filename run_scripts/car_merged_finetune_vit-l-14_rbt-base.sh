...
# data options
train_data=${DATAPATH}/datasets/car-V0.1/car_merged/lmdb/train
val_data=${DATAPATH}/datasets/car-V0.1/car_merged/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=car_merged_V0.1_finetune_vit-l-14_roberta-base-small-lr
