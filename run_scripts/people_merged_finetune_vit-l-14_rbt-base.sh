...
# data options
train_data=${DATAPATH}/datasets/people-V1.1/PA100K/subset/lmdb/train
val_data=${DATAPATH}/datasets/people-V1.1/PA100K/subset/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=people_merged_V1.1_finetune_vit-l-14_roberta-base-small-lr
