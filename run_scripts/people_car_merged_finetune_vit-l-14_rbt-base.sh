...
# data options
train_data=${DATAPATH}/datasets/car-V0.1-people-V1.1/car-merge-PA100K/lmdb/train
val_data=${DATAPATH}/datasets/car-V0.1-people-V1.1/car-merge-PA100K/lmdb/valid # if val_data is not specified, the validation will be automatically disabled

# restore options
resume=${DATAPATH}/pretrained_weights/clip_cn_vit-l-14.pt # or specify your customed ckpt path to resume
...
name=car-V0.1-people_V1.1_finetune_vit-l-14_roberta-base-small-lr
...
lr=1e-5
wd=0.001
max_epochs=300 # or you can alternatively specify --max-steps
