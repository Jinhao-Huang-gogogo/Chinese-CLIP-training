...
# data options
train_data=${DATAPATH}/datasets/cuhk03/lmdb/train
val_data=${DATAPATH}/datasets/cuhk03/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=cuhk03_finetune_vit-l-14_roberta-base
