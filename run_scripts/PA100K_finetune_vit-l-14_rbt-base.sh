...
# data options
train_data=${DATAPATH}/datasets/PA100K/lmdb/train
val_data=${DATAPATH}/datasets/PA100K/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
...
name=PA100K_finetune_vit-l-14_roberta-base
